...
_G.packer_plugins = {
  ...
  ["onedark.vim"] = {
    config = { "\27LJ\2\0029\0\0\2\0\3\0\0056\0\0\0009\0\1\0'\1\2\0B\0\2\1K\0\1\0\26 colorscheme onedark \bcmd\bvim\0" },
    loaded = true,
    path = "/home/feng/.local/share/nvim/site/pack/packer/start/onedark.vim",
...
try_loadstring("\27LJ\2\0029\0\0\2\0\3\0\0056\0\0\0009\0\1\0'\1\2\0B\0\2\1K\0\1\0\26 colorscheme onedark \bcmd\bvim\0", "config", "onedark.vim")
time([[Config for onedark.vim]], false)
-- Config for: oceanic-material
time([[Config for oceanic-material]], true)
try_loadstring("\27LJ\2\2\v\0\0\1\0\0\0\1K\0\1\0\0", "config", "oceanic-material")
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-clap', 'vim-floaterm', 'vim-cpp-enhanced-highlight', 'targets.vim', 'fennel.vim', 'vim-dispatch', 'vim-terminal-help', 'vista.vim', 'vim-win', 'nvim-colorizer.lua', 'vim-fugitive', 'awesome-cheatsheets', 'vim-surround', 'vim-gutentags', 'vim-unimpaired', 'vim-highlightedyank', 'vim-youdao-translater', 'vim-swap', 'vim-commentary', 'gutentags_plus'}, { event = "VimEnter *" }, _G.packer_plugins)]]
