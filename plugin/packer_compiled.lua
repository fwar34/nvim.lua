...
_G.packer_plugins = {
  ...
  ["nnn.vim"] = {
    ...
    config = { "\27LJ\2\2±\1\0\0\2\0\4\0\t6\0\0\0009\0\1\0'\1\2\0B\0\2\0016\0\0\0009\0\1\0'\1\3\0B\0\2\1K\0\1\0] let g:nnn#layout = { 'window': { 'width': 0.9, 'height': 0.6, 'highlight': 'Debug' } } ) let g:nnn#set_default_mappings = 0 \bcmd\bvim\0" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
vim.cmd [[au FileType fennel ++once lua require("packer.load")({'vim-sexp', 'conjure', 'vim-sexp-mappings-for-regular-people'}, { ft = "fennel" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType clojure ++once lua require("packer.load")({'vim-sexp', 'conjure', 'vim-sexp-mappings-for-regular-people'}, { ft = "clojure" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-clap', 'vim-floaterm', 'fennel.vim', 'vim-youdao-translater', 'vim-dispatch', 'vim-fugitive', 'vim-surround', 'vim-cpp-enhanced-highlight', 'vim-commentary', 'vim-unimpaired', 'vim-terminal-help', 'vim-gutentags', 'vim-highlightedyank', 'gutentags_plus', 'vim-swap', 'nvim-colorizer.lua', 'vim-win', 'vista.vim', 'targets.vim', 'awesome-cheatsheets'}, { event = "VimEnter *" }, _G.packer_plugins)]]
