...
_G.packer_plugins = {
  ...
  ["nnn.vim"] = {
    commands = { "NnnPicker", "Np" },
    config = { "\27LJ\1\2±\1\0\0\2\0\4\0\t4\0\0\0007\0\1\0%\1\2\0>\0\2\0014\0\0\0007\0\1\0%\1\3\0>\0\2\1G\0\1\0] let g:nnn#layout = { 'window': { 'width': 0.9, 'height': 0.6, 'highlight': 'Debug' } } ) let g:nnn#set_default_mappings = 0 \bcmd\bvim\0" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
    path = "/home/feng/.local/share/nvim/site/pack/packer/opt/nnn.vim",
  ...
  ["oceanic-material"] = {
    config = { "\27LJ\1\2B\0\0\2\0\3\0\0054\0\0\0007\0\1\0%\1\2\0>\0\2\1G\0\1\0# colorscheme oceanic_material \bcmd\bvim\0" },
    loaded = true,
  ...
  tagbar = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/feng/.local/share/nvim/site/pack/packer/opt/tagbar",
  ...
  ["vim-grepper"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/feng/.local/share/nvim/site/pack/packer/opt/vim-grepper",
...
try_loadstring("\27LJ\1\2B\0\0\2\0\3\0\0054\0\0\0007\0\1\0%\1\2\0>\0\2\1G\0\1\0# colorscheme oceanic_material \bcmd\bvim\0", "config", "oceanic-material")
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'vim-lua', 'BetterLua.vim'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-clap', 'vim-floaterm', 'LeaderF', 'vim-cpp-enhanced-highlight', 'gutentags_plus', 'vim-commentary', 'fennel.vim', 'vim-dispatch', 'vim-terminal-help', 'vista.vim', 'vim-win', 'nvim-colorizer.lua', 'vim-fugitive', 'awesome-cheatsheets', 'vim-youdao-translater', 'vim-surround', 'vim-gutentags', 'vim-unimpaired', 'vim-highlightedyank', 'vim-swap', 'targets.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
