...
vim.g.f_exclude_files = { 'debian', '*.am', '*.sh', 'makefile', 'Makefile', '*.html', '*.thrift', 'doxygen-doc',
  'Makefile.in', 'configure', 'config.status', 'libtool', 'auxdir', 'configure.ac' }
return {
  {
